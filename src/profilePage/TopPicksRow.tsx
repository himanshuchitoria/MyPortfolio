...
const topPicksConfig: Record<ProfileType, TopPick[]> = {
  ...
  adventurer: [
    ...
    { title: "Places Visited", imgSrc: "https://picsum.photos/id/1025/300/200", route: "/placesvisited", icon: <FaMusic /> },
    { title: "Movies Reviews & More", imgSrc: "https://th.bing.com/th/id/OIP.U1aFo8BQ5ZFv_7TWsP4SowHaEo?w=232&h=180&c=7&r=0&o=7&pid=1.7&rm=3", route: "/moviesection", icon: <FaMusic /> },
